...
public class Microflows
{
	...
	public static void example_OnFirstLoginAppCloudUser(IContext context, String _userIdentity)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("UserIdentity", _userIdentity);
			Core.execute(context, "AppCloudServices.Example_OnFirstLoginAppCloudUser", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
